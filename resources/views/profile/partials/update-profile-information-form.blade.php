<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            <!-- Displaying Current Profile Picture if Exists -->
            @if ($user->image)
                <div class="mb-3">
        ...
        <div>
            ...
            <x-textarea id="bio" name="bio" type="text" class="mt-1 block w-full" autofocus
                autocomplete="bio">{{ old('bio', $user->bio) }}</x-textarea>
