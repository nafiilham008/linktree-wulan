...
<body class="antialiased bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900">
    ...
    <div class="px-6 sm:p-0 sm:w-3/6 mx-auto mt-24 text-center">
        ...
        <p class="text-base  text-gray-600 dark:text-gray-400 mt-2 w:5/6 sm:w-4/5 mx-auto text-justify">
            {{ $user->bio }}
        </p>
        ...
        <section class="grid grid-flow-row gap-3 sm:gap-4 mt-8">
            ...
            @foreach ($links as $link)
                <a href="{{ route('clicks.store', [$user->username, $link, $link->title]) }}" target="_blank"
                    class="border border-gray-500 border-opacity-50 dark:border dark:border-slate-300 dark:border-opacity-30 hover:scale-[1.02] ease-out duration-200 rounded-lg">
